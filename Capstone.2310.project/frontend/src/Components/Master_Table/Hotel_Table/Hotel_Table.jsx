            ...
            <tbody>
              {hotelIds.slice(0, 10).map((hotelId, index) => (
                <tr
                  ...
                  onClick={() =>
                    handleRowClick(index, hotelId, hotelName[index])
                  }
                >
                  <td className="hotel-table-info">{hotelName[index]}</td>
                  <td className="hotel-table-info">{destinationCode}</td>
                  <td className="hotel-table-info">{departDate}</td>
                  <td className="hotel-table-info">{returnsDate}</td>
                </tr>
              ))}
            </tbody>
          </table>

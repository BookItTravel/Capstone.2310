          ...
          <table className="results-table">
            ...
            <tbody className="table-body">
              {returnFlightData &&
                ...
                returnFlightData.map((returns, index) => (
                  <tr
                    key={index}
                    className={
                      selectedRow === index ? "table-row selected" : "table-row"
                    } // Apply 'selected' class if the row is selected
                  ...
                  >
                    ...
                    <td className="table-info">
                      {returns.itineraries[0].segments[0].departure.at}
                      <br />
                      {returns.itineraries[0].segments[0].departure.iataCode}
                    </td>
                    <td className="table-info">
                      {returns.itineraries[0].segments[0].arrival.at}
                      <br />
                    ...
                    <td className="table-info">{returns.price.total}</td>
                  </tr>
                ))}
            </tbody>
          </table>

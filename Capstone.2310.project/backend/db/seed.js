  ...
  try {
    ...
    await db.query(`
            CREATE TABLE users (
                ...
                firstName VARCHAR(255) TEXT NOT NULL,
                lastName VARCHAR(255) TEXT NOT NULL,
                email VARCHAR(255) TEXT NOT NULL,
                phone VARCHAR(255) INTEGER NOT NULL,
                passportNumber VARCHAR(255) INTEGER UNIQUE NOT NULL
            );
